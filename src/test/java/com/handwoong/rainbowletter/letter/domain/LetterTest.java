...
class LetterTest {
    ...
    void 편지를_생성한다() {
        ...
        // when
        final Letter letter = Letter.create(request, testContainer.pet, testContainer.image, new FakeUuidGenerator());
        ...
        assertThat(letter.shareLink()).isEqualTo("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");
