...
public class PetController {
    ...
    public ResponseEntity<PetResponses> findAllByEmail(@RequestParam("email") String email) {
        final List<PetResponse> petResponses = petService.findAllByEmail(new Email(email));
        final PetResponses response = PetResponses.from(petResponses);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
